	      ...
	      <ul class="layui-nav layui-nav-tree"  lay-filter="test">
	        <li class="layui-nav-item layui-nav-itemed">
	          ...
	          <dl class="layui-nav-child">
	            ...
	            <dd><a href="javascript:;" class="tablink" id="productModify" tabsrc="/ncpsy/product/modify"><i class="layui-icon layui-icon-edit"></i> 修改农产品</a></dd>
